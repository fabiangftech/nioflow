 ...
 * the flow from there. A throwing fallback passes the new error to the next
 * recovery downstream.
 *
 * @param function turns the upstream failure into the replacement payload the
 *                 value resumes with
 * @param guards   the lane markers deciding which values may recover here
 */
